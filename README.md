...
| Input  | Output |
|--------|--------|
| ![alt text](./images/original.png "Input") | ![alt text](./images/modified.png "Output") |
...
The code for the developable face normal preference generation is in `utils_gauss/gauss_style_developable.cpp`. An explanation on the provided technique can be found at [this page](https://tobiasloch.github.io/developable-gauss-stylization/)
